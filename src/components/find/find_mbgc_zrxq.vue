...
.zrxq-list-up>div,.zrxq-list-up>div h4{
...
.zrxq-list-up>div>span>img{
	width: 1em;
	vertical-align:baseline;
}
.zrxq-list-up>div span{
	font-size: 12px;
	color: #999999;
}
.zrxq-list-up>div p{
...
.zrxq-list-up .list-up-img{
	width: 2.94em;
	height: 2.94em;
	margin: 0 .5em .2em 0;
}
.zrxq-list-up .list-up-img img{
	width: 100%;
	height: 100%;
	border-radius: 5px;  
